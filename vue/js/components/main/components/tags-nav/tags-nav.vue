<template>
  <div class="tags-nav">
    <div class="close-con">
      <Dropdown transfer @on-click="handleTagsOption" style="margin-top:7px;">
        <Button size="small" type="text">
          <i-icon :size="18" type="ios-close-circle-outline" />
        </Button>
    ...
    <div class="btn-con left-btn">
      <Button type="text" @click="handleScroll(240)" class="ivu-btn-text">
...
<script lang="babel">
import { showTitle, routeEqual } from 'babel!../../../../libs/util'
